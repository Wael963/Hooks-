...
function App() {
  ...
  const [movies, setMovies] = useState([{
    ...
    trailer: <iframe width="560" height="315" src="https://www.youtube.com/embed/CHekzSiZjrY?si=TLCGNpxndwQUMZPS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  },
  {
    title: "Extraction 2",
  ...
  trailer:<iframe width="560" height="315" src="https://www.youtube.com/embed/Y274jZs5s7s?si=TNEk1HMy-XGKMQcc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  },
  {
    ...
    trailer:<iframe width="560" height="315" src="https://www.youtube.com/embed/_InqQJRqGW4?si=xFYEgnyU3ionV0aP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  }
  ])
  return (
    <div className="App">
